...
export default function HomePage() {
  ...
  return (
    <>
      {/* Header - без padding-top, чтобы не было лишнего пространства */}
      <div className="bg-[#367666] text-white px-6 pt-8 pb-6">
      ...
      <div className="bg-gray-50 pb-28">
        {/* WebSocket Status - теперь внутри контента, не фиксированный */}
        <div className={`fixed top-2 right-2 z-50 px-2 py-1 rounded-full text-xs ${
